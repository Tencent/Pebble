...
#ifndef THIRDPARTY_INIH_MASTER_CPP_INIREADER_H_
#define THIRDPARTY_INIH_MASTER_CPP_INIREADER_H_
...
class INIReader {
 public:
    ...
    // or hex "0x4d2").
    int32_t GetInteger(std::string section, std::string name,
    ...
    // Set a value overwrite the old, or add a new value
...
#endif  // THIRDPARTY_INIH_MASTER_CPP_INIREADER_H_
