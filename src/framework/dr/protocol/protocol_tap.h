...
#ifndef PEBBLE_DR_PROTOCOL_PROTOCOLTAP_H
#define PEBBLE_DR_PROTOCOL_PROTOCOLTAP_H

#include "framework/dr/protocol/TVirtualProtocol.h"
...
#endif // PEBBLE_DR_PROTOCOL_PROTOCOLTAP_H
