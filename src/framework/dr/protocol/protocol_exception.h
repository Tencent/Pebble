...
#ifndef PEBBLE_DR_PROTOCOL_PROTOCOLEXCEPTION_H
#define PEBBLE_DR_PROTOCOL_PROTOCOLEXCEPTION_H
 ...
 *
 */
class TProtocolException : public pebble::TException {
 public:
...
#endif // PEBBLE_DR_PROTOCOL_PROTOCOLEXCEPTION_H
