                             ...
                             const ACL_vector* acl, int flags, ZkStringCompletionCb cob)
{
    ...
    if (flags == ZOO_EPHEMERAL)
    {
        ZkEphemeralCreateCallBackHolder *holder =
            new ZkEphemeralCreateCallBackHolder(this, cob);
    ...
    {
        ZkCallBackHolder<ZkStringCompletionCb> *holder =
            new ZkCallBackHolder<ZkStringCompletionCb>(cob);
        ret = zoo_acreate(m_zk_handle, path, value, value_length,
                            ...
                            const ACL_vector* acl, int flags)
{
    ...
    ZkStringCompletionCb cob = cxx::bind(&ZkStringCompletionRsp::OnRsp,
                                         &rsp, _1, _2);
    int ret = ACreate(path, value, value_length, acl, flags, cob);
    if (0 != ret)
    {
        return ret;
    }
...
int ZookeeperClient::AGet(const char* path, int watch, ZkDataCompletionCb cob)
{
    if (NULL == m_zk_handle || NULL == path)
    {
        return kZK_APIERROR;
    ...
    ZkCallBackHolder<ZkDataCompletionCb>* holder =
        new ZkCallBackHolder<ZkDataCompletionCb>(cob);
...
int ZookeeperClient::Get(const char* path, int watch, char* buffer, int* length, Stat* stat)
{
    ...
    ZkDataCompletionCb cob = cxx::bind(&ZkDataCompletionRsp::OnRsp,
                                       &rsp, _1, _2, _3, _4);
    int ret = AGet(path, watch, cob);
    if (0 != ret)
    {
        return ret;
    }
                          ...
                          ZkStatCompletionCb cob)
{
    ...
    ZkCallBackHolder<ZkStatCompletionCb>* holder =
        new ZkCallBackHolder<ZkStatCompletionCb>(cob);
...
int ZookeeperClient::Set(const char* path, const char* buffer, int buflen, int version, Stat* stat)
{
    ...
    ZkStatCompletionCb cob = cxx::bind(&ZkStatCompletionRsp::OnRsp,
                                       &rsp, _1, _2);
    int ret = ASet(path, buffer, buflen, version, cob);
    if (0 != ret)
    {
        return ret;
    }
...
int ZookeeperClient::ADelete(const char* path, int version, ZkVoidCompletionCb cob)
{
    if (NULL == m_zk_handle || NULL == path)
    {
        return kZK_APIERROR;
    ...
    ZkCallBackHolder<ZkVoidCompletionCb>* holder =
        new ZkCallBackHolder<ZkVoidCompletionCb>(cob);
...
int ZookeeperClient::Delete(const char* path, int version)
{
    ...
    ZkVoidCompletionCb cob = cxx::bind(&ZkVoidCompletionRsp::OnRsp, &rsp, _1);
    int ret = ADelete(path, version, cob);
    if (0 != ret)
    {
        return ret;
    }
...
int ZookeeperClient::AExists(const char* path, int watch, ZkStatCompletionCb cob)
{
    if (NULL == m_zk_handle || NULL == path)
    {
        return kZK_APIERROR;
...
int ZookeeperClient::Exists(const char* path, int watch, Stat* stats)
{
    ...
    ZkStatCompletionCb cob = cxx::bind(&ZkStatCompletionRsp::OnRsp,
                                       &rsp, _1, _2);
    int ret = AExists(path, watch, cob);
    if (0 != ret)
    {
        return ret;
    }
...
int ZookeeperClient::WExists(const char* path, watcher_fn watcher, void* watcherCtx, Stat* stat)
{
    ...
    ZkStatCompletionCb cob = cxx::bind(&ZkStatCompletionRsp::OnRsp,
                                       &rsp, _1, _2);
    int ret = AWExists(path, watcher, watcherCtx, cob);
    if (0 != ret)
    {
        return ret;
    }
...
int ZookeeperClient::AGetChildren(const char* path, int watch, ZkStringsCompletionCb cob)
{
    if (NULL == m_zk_handle || NULL == path)
    {
        return kZK_APIERROR;
    ...
    ZkCallBackHolder<ZkStringsCompletionCb>* holder =
        new ZkCallBackHolder<ZkStringsCompletionCb>(cob);
...
int ZookeeperClient::GetChildren(const char* path, int watch, String_vector* children, Stat* stat)
{
    ...
    ZkStringsCompletionCb cob = cxx::bind(&ZkStringsCompletionRsp::OnRsp,
                                          &rsp, _1, _2, _3);
    int ret = AGetChildren(path, watch, cob);
    if (0 != ret)
    {
        return ret;
    }
...
int ZookeeperClient::AGetAcl(const char *path, ZkAclCompletionCb cob)
{
    if (NULL == m_zk_handle || NULL == path)
    {
        return kZK_APIERROR;
    ...
    ZkCallBackHolder<ZkAclCompletionCb>* holder =
        new ZkCallBackHolder<ZkAclCompletionCb>(cob);
...
int ZookeeperClient::GetAcl(const char *path, struct ACL_vector* acl)
{
    ...
    ZkAclCompletionCb cob = cxx::bind(&ZkAclCompletionRsp::OnRsp,
                                      &rsp, _1, _2, _3);
    int ret = AGetAcl(path, cob);
    if (0 != ret)
    {
        return ret;
    }
