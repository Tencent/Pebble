...
#ifndef PEBBLE_RPC_REFLECTION_H
#define PEBBLE_RPC_REFLECTION_H

#include <string>
#include <tr1/unordered_map>
#include <map>

namespace pebble { namespace rpc { namespace reflection {
...
public:
    /// @brief 获取字段类型
    /// @return 字段类型
    inline pebble::rpc::protocol::TType GetFieldType() const {
        return m_field_type;
    }
...
private:
    ...
    pebble::rpc::protocol::TType m_field_type;
...
template<typename T>
const TypeInfo* GetTypeInfo(T obj) {
    return T::S_GetTypeInfo();
}
