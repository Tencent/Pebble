...
#ifndef PEBBLE_RPC_COMMON_FP_UTIL_H
#define PEBBLE_RPC_COMMON_FP_UTIL_H

#include <limits>

namespace pebble { namespace rpc { namespace floating_point {
...
#endif // PEBBLE_RPC_COMMON_FP_UTIL_H
