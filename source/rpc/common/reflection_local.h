...
#ifndef PEBBLE_RPC_REFLECTIONLOCAL_H
#define PEBBLE_RPC_REFLECTIONLOCAL_H
...
namespace pebble { namespace rpc { namespace reflection { namespace local {

using pebble::rpc::protocol::TType;
...
struct TypeSpec {
    ...
    explicit TypeSpec(TType ttype) : ttype(ttype) {
...
#endif // PEBBLE_RPC_REFLECTIONLOCAL_H
