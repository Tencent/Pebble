...
#ifndef PEBBLE_RPC_PROTOCOL_DEBUGPROTOCOL_H
#define PEBBLE_RPC_PROTOCOL_DEBUGPROTOCOL_H

#include "source/rpc/protocol/virtual_protocol.h"
...
class TDebugProtocol : public TVirtualProtocol<TDebugProtocol> {
 ...
 public:
  TDebugProtocol(cxx::shared_ptr<TTransport> trans)
...
class TDebugProtocolFactory : public TProtocolFactory {
 public:
  ...
  cxx::shared_ptr<TProtocol> getProtocol(cxx::shared_ptr<TTransport> trans) {
    return cxx::shared_ptr<TProtocol>(new TDebugProtocol(trans));
  }
...
// TODO: we only support tbus transport now!

// TODO(dreiss): Move (part of) ThriftDebugString into a .cpp file and remove this.
#if 0
#include "rpc/transport/buffer_transports.h"
...
#endif // PEBBLE_RPC_PROTOCOL_DEBUGPROTOCOL_H
