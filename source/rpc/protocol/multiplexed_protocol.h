...
#ifndef PEBBLE_RPC_MULTIPLEXEDPROTOCOL_H
#define PEBBLE_RPC_MULTIPLEXEDPROTOCOL_H

#include "source/rpc/protocol/protocol_decorator.h"
...
public:
     ...
     */
     TMultiplexedProtocol( cxx::shared_ptr<TProtocol> _protocol, const std::string& _serviceName )
    ...
    void setServiceName(const std::string& service_name) { serviceName = service_name; }
...
#endif // PEBBLE_RPC_MULTIPLEXEDPROTOCOL_H
