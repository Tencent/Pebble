...
#ifndef PEBBLE_RPC_PROTOCOL_BINARYPROTOCOL_H
#define PEBBLE_RPC_PROTOCOL_BINARYPROTOCOL_H
...
#include "source/rpc/protocol/binary_protocol.tcc"

#endif // PEBBLE_RPC_PROTOCOL_BINARYPROTOCOL_H
