...
#ifndef PEBBLE_RPC_PROTOCOL_VIRTUALPROTOCOL_H
#define PEBBLE_RPC_PROTOCOL_VIRTUALPROTOCOL_H
...
class TVirtualProtocol : public Super_ {
 public:
  ...
  uint32_t skip(TType type) {
    ...
    return pebble::rpc::protocol::skip(*prot, type);
  }
...
#endif // PEBBLE_RPC_PROTOCOL_VIRTUALPROTOCOL_H
