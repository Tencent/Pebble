...
#ifndef PEBBLE_RPC_PROTOCOL_DENSEPROTOCOL_H
#define PEBBLE_RPC_PROTOCOL_DENSEPROTOCOL_H

#include "source/rpc/protocol/binary_protocol.h"
#include "source/rpc/common/reflection_local.h"
...
class TDenseProtocol
 ...
 public:
  typedef pebble::rpc::reflection::local::TypeSpec TypeSpec;
   ...
   */
  TDenseProtocol(cxx::shared_ptr<TTransport> trans,
  ...
  inline uint32_t subWriteI64(const int64_t i64);
  ...
  inline uint32_t subReadI64(int64_t& i64);
...
#endif // PEBBLE_RPC_PROTOCOL_DENSEPROTOCOL_H
