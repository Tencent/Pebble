...
#ifndef PEBBLE_RPC_PROTOCOL_PROTOCOLTAP_H
#define PEBBLE_RPC_PROTOCOL_PROTOCOLTAP_H

#include "source/rpc/protocol/TVirtualProtocol.h"

namespace pebble { namespace rpc { namespace protocol {

using pebble::rpc::transport::TTransport;
...
class TProtocolTap : public TVirtualProtocol<TProtocolTap> {
 public:
   TProtocolTap(cxx::shared_ptr<TProtocol> source,
                cxx::shared_ptr<TProtocol> sink)
 ...
 private:
  cxx::shared_ptr<TProtocol> source_;
  cxx::shared_ptr<TProtocol> sink_;
};

}}} // pebble::rpc::protocol

#endif // PEBBLE_RPC_PROTOCOL_PROTOCOLTAP_H
