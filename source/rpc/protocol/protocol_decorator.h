...
#ifndef PEBBLE_RPC_PROTOCOLDECORATOR_H
#define PEBBLE_RPC_PROTOCOLDECORATOR_H
...
public:
    ...
    TProtocolDecorator( cxx::shared_ptr<TProtocol> proto )
    ...
    virtual uint32_t readMessageBegin_virt(std::string& name, TMessageType& messageType, int64_t& seqid) { return protocol->readMessageBegin(name,messageType,seqid); }
...
#endif // PEBBLE_RPC_PROTOCOLDECORATOR_H
