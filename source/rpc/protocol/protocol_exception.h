...
#ifndef PEBBLE_RPC_PROTOCOL_PROTOCOLEXCEPTION_H
#define PEBBLE_RPC_PROTOCOL_PROTOCOLEXCEPTION_H
 ...
 *
 */
class TProtocolException : public pebble::rpc::TException {
 public:
...
#endif // PEBBLE_RPC_PROTOCOL_PROTOCOLEXCEPTION_H
