...
#ifndef PEBBLE_RPC_PROTOCOL_PROTOCOL_H
#define PEBBLE_RPC_PROTOCOL_PROTOCOL_H

#include "source/rpc/common/rpc_define.h"
#include "source/rpc/transport/transport.h"
#include "source/rpc/protocol/protocol_exception.h"
...
#  include <source/rpc/common/endian.hpp>
...
class TProtocol {
 public:
  ...
  virtual uint32_t skip_virt(TType type) {
    return pebble::rpc::protocol::skip(*this, type);
  }
...
#endif // PEBBLE_RPC_PROTOCOL_PROTOCOL_H
