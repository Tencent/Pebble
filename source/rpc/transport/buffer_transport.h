...
#ifndef PEBBLE_RPC_TRANSPORT_TBUFFERTRANSPORT_H
#define PEBBLE_RPC_TRANSPORT_TBUFFERTRANSPORT_H
...
public:
    ...
    uint32_t readAll(uint8_t* buf, uint32_t len) {
        ...
        return pebble::rpc::transport::readAll(*this, buf, len);
    }
...
#endif // PEBBLE_RPC_TRANSPORT_TBUFFERTRANSPORT_H
