...
#ifndef PEBBLE_RPC_TRANSPORT_TTRANSPORTEXCEPTION_H
#define PEBBLE_RPC_TRANSPORT_TTRANSPORTEXCEPTION_H
 ...
 *
 */
class TTransportException : public pebble::rpc::TException {
public:
    /**
    ...
    TTransportException(TTransportExceptionType type,
        ...
        int errno_copy) :
        pebble::rpc::TException(message + ": " + TOutput::strerror_s(errno_copy)),
        type_(type) {}
...
#endif // PEBBLE_RPC_TRANSPORT_TTRANSPORTEXCEPTION_H
