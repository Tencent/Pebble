...
#ifndef PEBBLE_RPC_TRANSPORT_TTRANSPORT_H
#define PEBBLE_RPC_TRANSPORT_TTRANSPORT_H

#include <string>
#include <tr1/memory>
#include "source/rpc/transport/transport_exception.h"
...
#endif // PEBBLE_RPC_TRANSPORT_TTRANSPORT_H
