...
string t_go_generator::go_autogen_comment() {
    ...
    version.append(")\n\n");
    version.append("DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING\n");
    return version;
}
...
THRIFT_REGISTER_GENERATOR(go, "Go",
                          ...
                          "    pebble_import=  Override pebble package import path\n" \
                          "    package=  Package name (default: inferred from pebble file name)\n")
